...
min = indeks_minimuma(niz,n);           // min dobija vrednost koju vraca funkcija indeks_minimum
max = indeks_maksimuma(niz,n);          // max dobija vrednost koju vraca funkcija indeks_minimum
