...
void ucitaj(int a[],int n)	/*funkcija za upis niza*/
{
int i;
for(i=0;i<n;i++)
  scanf("%d",&a[i]);
}
int indeks_minimuma(int a[],int n)
{
int min;
int k=0,i;
...
/*ispitujemo da li je neki od preostalih clanova veci od opstavljenog maksimuma, i ako jeste, 
