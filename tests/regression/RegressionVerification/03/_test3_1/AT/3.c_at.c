...
void izmeni(char a[]) {
  /*pravimo izmeni, on je tipa void, pa nema return, u njemu vrtimo jedan for
ciklus koji cita elemente niske a, proverava za parna mesta da li
				   su mala slova kako bi ih pretvorio u velika, a za neparna mesta radi
obrnuto. Za ostale znake ne radi nista. */
  int i;
  for (i = 0; a[i]; i++) {
