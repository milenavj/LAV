...
entry:
  ...
  %call = call i32 (i8*, ...)* @__isoc99_scanf(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32* %a, i32* %b), !dbg !12
  %0 = load i32* %a, align 4, !dbg !13
  %1 = load i32* %b, align 4, !dbg !13
  %div = sdiv i32 %0, %1, !dbg !13
  %call1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str1, i32 0, i32 0), i32 %div), !dbg !13
  ret i32 0, !dbg !14
}
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.3 (tags/RELEASE_33/final)", i1 false, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/milena/lav/LAV/tests/branislava_tests/primer2.c] [DW_LANG_C99]
!1 = metadata !{metadata !"primer2.c", metadata !"/home/milena/lav/LAV/tests/branislava_tests"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/milena/lav/LAV/tests/branislava_tests/primer2.c]
