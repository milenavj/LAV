...
public:
  ...
  explicit BVExpressionImpMathSAT()
      : ExpressionImpSymbolic(EK_ExpressionImpMathSAT) {}

  explicit BVExpressionImpMathSAT(SOLVER_EXPR_TYPE expr, size_t width,
                                  MathSATType type)
  ...
  ExpressionImp *unsignedSymbolic(const std::string &name, size_t width) const {
    msat_decl decl = msat_declare_variable(
        getSolver(), const_cast<char *>(name.c_str()), MSAT_BV + width);
  ...
  ExpressionImp *integerGround(unsigned x, size_t width) const {
    return new BVExpressionImpMathSAT(solverUnsignedExprFromGround(x, width),
                                      width, MATHSAT_BITVECTOR);
  }

  ExpressionImp *integerGround(signed x, size_t width) const {
    return new BVExpressionImpMathSAT(solverSignedExprFromGround(x, width),
                                      width, MATHSAT_BITVECTOR);
  }
  ...
  ExpressionImp *booleanGround(bool x) const {
    return new BVExpressionImpMathSAT(solverBooleanExprFromGround(x), 1,
                                      MATHSAT_BOOLEAN);
  }

  virtual ExpressionImp *
  addGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_plus(getSolver(), this->_expr,
  ...
  addSymbolic(const ExpressionImpSymbolic *const e) const {
    ...
    SOLVER_EXPR_TYPE exp =
        msat_make_bv_plus(getSolver(), this->_expr, bexpr->_expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }

  virtual ExpressionImp *
  subtractGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_minus(getSolver(), this->_expr,
                                              solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  subtractFromGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_minus(
  ...
  multGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_times(getSolver(), this->_expr,
                                              solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  udivGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_udiv(getSolver(), this->_expr,
                                             solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  udivFromGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_udiv(
        getSolver(), solverUnsignedExprFromGround(e), this->_expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  sdivGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_sdiv(getSolver(), this->_expr,
  ...
  sdivFromGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_sdiv(
        getSolver(), solverSignedExprFromGround(e), this->_expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  uremGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_urem(getSolver(), this->_expr,
                                             solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  uremFromGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_urem(
        getSolver(), solverUnsignedExprFromGround(e), this->_expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  sremGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_srem(getSolver(), this->_expr,
                                             solverSignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  sremFromGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_srem(
        getSolver(), solverSignedExprFromGround(e), this->_expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  bitXorGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_xor(getSolver(), this->_expr,
                                            solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  bitAndGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_and(getSolver(), this->_expr,
                                            solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  bitOrGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_or(getSolver(), this->_expr,
                                           solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  virtual ExpressionImp *bitNot() const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_not(getSolver(), this->_expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  shiftLForGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_lsl(getSolver(), this->_expr,
                                            solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  shiftLGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_lsl(
        getSolver(), solverUnsignedExprFromGround(e), this->_expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  shiftLForSymbolic(const ExpressionImpSymbolic *const e) const {
    const BVExpressionImpMathSAT *const bexpr =
        llvm::dyn_cast<BVExpressionImpMathSAT>(e);
    assert(bexpr != 0);
    SOLVER_EXPR_TYPE exp = msat_make_bv_lsl(getSolver(), _expr, bexpr->_expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  ...
  shiftLSymbolic(const ExpressionImpSymbolic *const e) const {
    const BVExpressionImpMathSAT *const bexpr =
        llvm::dyn_cast<BVExpressionImpMathSAT>(e);
    assert(bexpr != 0);
    SOLVER_EXPR_TYPE exp = msat_make_bv_lsl(getSolver(), bexpr->_expr, _expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }

  virtual ExpressionImp *
  lShiftRForGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_lsr(getSolver(), this->_expr,
                                            solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  lShiftRGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_lsr(
        getSolver(), solverUnsignedExprFromGround(e), this->_expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  lShiftRSymbolic(const ExpressionImpSymbolic *const e) const {
    const BVExpressionImpMathSAT *const bexpr =
        llvm::dyn_cast<BVExpressionImpMathSAT>(e);
    assert(bexpr != 0);
    SOLVER_EXPR_TYPE exp = msat_make_bv_lsr(getSolver(), bexpr->_expr, _expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  lShiftRForSymbolic(const ExpressionImpSymbolic *const e) const {
    const BVExpressionImpMathSAT *const bexpr =
        llvm::dyn_cast<BVExpressionImpMathSAT>(e);
    assert(bexpr != 0);
    SOLVER_EXPR_TYPE exp = msat_make_bv_lsr(getSolver(), _expr, bexpr->_expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }

  virtual ExpressionImp *
  aShiftRForGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_asr(getSolver(), this->_expr,
                                            solverSignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  aShiftRGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_asr(
        getSolver(), solverSignedExprFromGround(e), this->_expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  aShiftRSymbolic(const ExpressionImpSymbolic *const e) const {
    const BVExpressionImpMathSAT *const bexpr =
        llvm::dyn_cast<BVExpressionImpMathSAT>(e);
    assert(bexpr != 0);
    SOLVER_EXPR_TYPE exp = msat_make_bv_asr(getSolver(), bexpr->_expr, _expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }
  ...
  aShiftRForSymbolic(const ExpressionImpSymbolic *const e) const {
    const BVExpressionImpMathSAT *const bexpr =
        llvm::dyn_cast<BVExpressionImpMathSAT>(e);
    assert(bexpr != 0);
    SOLVER_EXPR_TYPE exp = msat_make_bv_asr(getSolver(), _expr, bexpr->_expr);
    return new BVExpressionImpMathSAT(exp, _width, MATHSAT_BITVECTOR);
  }

  virtual ExpressionImp *
  ultGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_ult(getSolver(), this->_expr,
                                            solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, 1, MATHSAT_BOOLEAN);
  }
  ...
  uleGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_uleq(getSolver(), this->_expr,
                                             solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, 1, MATHSAT_BOOLEAN);
  }
  ...
  sltGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_slt(getSolver(), this->_expr,
                                            solverSignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, 1, MATHSAT_BOOLEAN);
  }
  ...
  sleGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_sleq(getSolver(), this->_expr,
                                             solverSignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, 1, MATHSAT_BOOLEAN);
  }
  ...
  ugtGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_ugt(getSolver(), this->_expr,
                                            solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, 1, MATHSAT_BOOLEAN);
  }
  ...
  ugeGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_ugeq(getSolver(), this->_expr,
                                             solverUnsignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, 1, MATHSAT_BOOLEAN);
  }
  ...
  sgtGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_sgt(getSolver(), this->_expr,
                                            solverSignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, 1, MATHSAT_BOOLEAN);
  }
  ...
  sgeGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_sgeq(getSolver(), this->_expr,
                                             solverSignedExprFromGround(e));
    return new BVExpressionImpMathSAT(exp, 1, MATHSAT_BOOLEAN);
  }
  ...
  virtual ExpressionImp *ite_(ExpressionImp *thenExpr,
    ...
    return new BVExpressionImpMathSAT(exp, bthenExpr->_width,
                                      MATHSAT_BITVECTOR);
  }

  virtual ExpressionImp *sextimp(size_t width) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_sext(getSolver(), this->_expr, width);
    return new BVExpressionImpMathSAT(exp, width, MATHSAT_BITVECTOR);
  }

  virtual ExpressionImp *zextimp(size_t width) const {
    SOLVER_EXPR_TYPE exp = msat_make_bv_zext(getSolver(), this->_expr, width);
    return new BVExpressionImpMathSAT(exp, width, MATHSAT_BITVECTOR);
  }
