...
namespace UrsaMajor {
  ...
  public:
    ...
    explicit LAExpressionImpMathSAT() : ExpressionImpSymbolic(EK_ExpressionImpMathSAT) {}
...
//      MathSATInstance::instance().pop();
    ...
    ExpressionImp* unsignedSymbolic(const std::string& name, size_t width) const {
      msat_decl decl = msat_declare_variable(getSolver(), const_cast<char*>(name.c_str()), MSAT_INT);
	...
	msat_make_plus(getSolver(), this->_expr, solverUnsignedExprFromGround(e));
      return new LAExpressionImpMathSAT(exp);
    }
	...
	llvm::dyn_cast<LAExpressionImpMathSAT>(e);
      assert(bexpr != 0);
      SOLVER_EXPR_TYPE exp = msat_make_plus(getSolver(), this->_expr, bexpr->_expr);
      return new LAExpressionImpMathSAT(exp);
    }

    virtual ExpressionImp* subtractGround(const ExpressionImpGroundInteger* const e) const {
      SOLVER_EXPR_TYPE exp = 
	msat_make_minus(getSolver(), this->_expr, solverUnsignedExprFromGround(e));
      return new LAExpressionImpMathSAT(exp);
    }

    virtual ExpressionImp* subtractFromGround(const ExpressionImpGroundInteger* const e) const {
      SOLVER_EXPR_TYPE exp = 
	msat_make_minus(getSolver(), solverUnsignedExprFromGround(e), this->_expr);
      return new LAExpressionImpMathSAT(exp);
    }
    ...
    virtual ExpressionImp* multGround(const ExpressionImpGroundInteger* const e) const {
      SOLVER_EXPR_TYPE exp = 
	msat_make_times(getSolver(), this->_expr, solverUnsignedExprFromGround(e));
      return new LAExpressionImpMathSAT(exp);
    }
	...
	llvm::dyn_cast<LAExpressionImpMathSAT>(e);
      assert(bexpr != 0);
      SOLVER_EXPR_TYPE exp = 
	msat_make_or(getSolver(), this->_expr, bexpr->_expr);
      return new LAExpressionImpMathSAT(exp);
    }
	...
	llvm::dyn_cast<LAExpressionImpMathSAT>(e);
      assert(bexpr != 0);      
      SOLVER_EXPR_TYPE exp = 
	msat_make_lt(getSolver(), this->_expr, bexpr->_expr);
      return new LAExpressionImpMathSAT(exp);
    }

    virtual ExpressionImp* uleGround(const ExpressionImpGroundInteger* const e) const {
      SOLVER_EXPR_TYPE exp = 
        msat_make_leq(getSolver(), this->_expr, solverUnsignedExprFromGround(e));
      return new LAExpressionImpMathSAT(exp);
    }
	...
	llvm::dyn_cast<LAExpressionImpMathSAT>(e);
      assert(bexpr != 0);      
      SOLVER_EXPR_TYPE exp = 
	msat_make_gt(getSolver(), this->_expr, bexpr->_expr);
      return new LAExpressionImpMathSAT(exp);
    }

    virtual ExpressionImp* ugeGround(const ExpressionImpGroundInteger* const e) const {
      SOLVER_EXPR_TYPE exp = 
        msat_make_geq(getSolver(), this->_expr, solverUnsignedExprFromGround(e));
      return new LAExpressionImpMathSAT(exp);
    }
...
//FIXME unsigned???
    virtual ExpressionImp* eqGround(const ExpressionImpGroundInteger* const e) const {
      SOLVER_EXPR_TYPE exp = 
	msat_make_equal(getSolver(), this->_expr, solverSignedExprFromGround(e));
      return new LAExpressionImpMathSAT(exp);
    }
