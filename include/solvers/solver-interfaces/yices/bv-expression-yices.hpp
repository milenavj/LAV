...
public:
  ...
  explicit BVExpressionImpYices(SOLVER_EXPR_TYPE expr, size_t width,
                                YicesType type)
  ...
  addGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_add(getSolver(), this->_expr,
  ...
  addSymbolic(const ExpressionImpSymbolic *const e) const {
    ...
    assert(bexpr != 0);
    SOLVER_EXPR_TYPE exp =
        yices_mk_bv_add(getSolver(), this->_expr, bexpr->_expr);
    return new BVExpressionImpYices(exp, _width, YICES_BITVECTOR);
  }
  ...
  subtractFromGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_sub(
  ...
  multGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_mul(getSolver(), this->_expr,
                                           solverUnsignedExprFromGround(e));
    return new BVExpressionImpYices(exp, _width, YICES_BITVECTOR);
  }
  ...
  bitXorGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_xor(getSolver(), this->_expr,
                                           solverUnsignedExprFromGround(e));
    return new BVExpressionImpYices(exp, _width, YICES_BITVECTOR);
  }
  ...
  bitAndGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_and(getSolver(), this->_expr,
                                           solverUnsignedExprFromGround(e));
    return new BVExpressionImpYices(exp, _width, YICES_BITVECTOR);
  }
  ...
  bitOrGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_or(getSolver(), this->_expr,
                                          solverUnsignedExprFromGround(e));
    return new BVExpressionImpYices(exp, _width, YICES_BITVECTOR);
  }
  ...
  virtual ExpressionImp *bitNot() const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_not(getSolver(), this->_expr);
    return new BVExpressionImpYices(exp, _width, YICES_BITVECTOR);
  }
  ...
  shiftLForGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_shift_left0(getSolver(), this->_expr,
                                                   e->getUnsignedValue());
    return new BVExpressionImpYices(exp, _width, YICES_BITVECTOR);
  }
  ...
  lShiftRForGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_shift_right0(getSolver(), this->_expr,
                                                    e->getUnsignedValue());
    return new BVExpressionImpYices(exp, _width, YICES_BITVECTOR);
  }

  //    virtual ExpressionImp* aShiftRForGround(const
  // ExpressionImpGroundInteger* const e) const {
  //      throw "yices::ExpressionImpSymbolic::aShiftRForGround N/A";
  //    }

  virtual ExpressionImp *
  sltGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_slt(getSolver(), this->_expr,
                                           solverUnsignedExprFromGround(e));
    return new BVExpressionImpYices(exp, 1, YICES_BOOLEAN);
  }
  ...
  sgtGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_sgt(getSolver(), this->_expr,
                                           solverUnsignedExprFromGround(e));
    return new BVExpressionImpYices(exp, 1, YICES_BOOLEAN);
  }
  ...
  sleGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_sle(getSolver(), this->_expr,
                                           solverUnsignedExprFromGround(e));
    return new BVExpressionImpYices(exp, 1, YICES_BOOLEAN);
  }
  ...
  sgeGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_sge(getSolver(), this->_expr,
                                           solverUnsignedExprFromGround(e));
    return new BVExpressionImpYices(exp, 1, YICES_BOOLEAN);
  }
  ...
  ultGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_lt(getSolver(), this->_expr,
                                          solverUnsignedExprFromGround(e));
    return new BVExpressionImpYices(exp, 1, YICES_BOOLEAN);
  }
  ...
  ugtGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_gt(getSolver(), this->_expr,
                                          solverUnsignedExprFromGround(e));
    return new BVExpressionImpYices(exp, 1, YICES_BOOLEAN);
  }
  ...
  uleGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_le(getSolver(), this->_expr,
                                          solverUnsignedExprFromGround(e));
    return new BVExpressionImpYices(exp, 1, YICES_BOOLEAN);
  }
  ...
  ugeGround(const ExpressionImpGroundInteger *const e) const {
    SOLVER_EXPR_TYPE exp = yices_mk_bv_ge(getSolver(), this->_expr,
                                          solverUnsignedExprFromGround(e));
    return new BVExpressionImpYices(exp, 1, YICES_BOOLEAN);
  }
  ...
  virtual ExpressionImp *zextimp(size_t width) const {
    //      SOLVER_EXPR_TYPE exp = yices_mk_bv_sign_extend(getSolver(),
    // this->_expr, width);
    //      return new BVExpressionImpYices(exp, _width, YICES_BITVECTOR);
  ...
  virtual ExpressionImp *sextimp(size_t width) const {
    SOLVER_EXPR_TYPE exp =
        yices_mk_bv_sign_extend(getSolver(), this->_expr, width - _width);
    return new BVExpressionImpYices(exp, width, YICES_BITVECTOR);
  }
...
public:
  BVExpressionFactoryYices() : ExpressionFactory(new BVExpressionImpYices()) {}
};
