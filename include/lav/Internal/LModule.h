...
public:
  ...
  const std::set<llvm::GlobalVariable*>&          GlobalReferences() const  {return _GlobalReferences; }
         std::set<llvm::GlobalVariable*>&          GlobalReferences()        {return _GlobalReferences; }
  const std::set<llvm::GlobalVariable*>&          GlobalVariables()  const  {return _GlobalVariables; }
         std::set<llvm::GlobalVariable*>&          GlobalVariables()         {return _GlobalVariables; }
