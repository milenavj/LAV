...
namespace lav
{
  ...
  public:
    ...
    inline const std::vector<llvm::Instruction*>&  GetReturnInstructions() const { return _ReturnInstructions; }
    inline int                                     GetContext()            const { return _Context; }
    inline const std::map<std::string, llvm::Type*>& GetReferences()       const { return _References;}
    inline cStr&                                    GetFunctionName()       const { return _FunctionName; }
    inline const LConstraints&              FunctionConstraints()          const { return _FunctionConstraints; }
    inline        LConstraints&              FunctionConstraints()                 { return _FunctionConstraints; }
    inline aExp                             GetFunctionConstraints()       const  {return _FunctionConstraints.Constraint();}
  ...
  private:
    ...
    void SetReferences();
    void SetAddresses();
    bool AddAllocationFixedAddress(llvm::AllocaInst *ai, vStr& variables, vVarInfo& fvis );
